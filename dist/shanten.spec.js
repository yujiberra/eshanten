...
describe("fitsInSet", function () {
    it("should correctly identify what fits into a singleton tuple", function () {
        ...
        expect(shanten_1.fitsInSet(parse_1.parseOne("1z"), nanPair)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("5p"), nanPair)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("2z"), nanPair)).toBeTrue();
        const akaPair = { tiles: parse_1.parse("r5m"), type: "tuple" };
        expect(shanten_1.fitsInSet(parse_1.parseOne("1z"), akaPair)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("5p"), akaPair)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("4m"), akaPair)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("5m"), akaPair)).toBeTrue();
    });
    ...
    it("should correctly identify what fits into a singleton run", function () {
        ...
        expect(shanten_1.fitsInSet(parse_1.parseOne("1z"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("r5m"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("1s"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("4p"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("1m"), run)).toBeTrue();
        expect(shanten_1.fitsInSet(parse_1.parseOne("3m"), run)).toBeTrue();
        expect(shanten_1.fitsInSet(parse_1.parseOne("4m"), run)).toBeTrue();
    });
    it("should correctly identify what fits into a ryanmen", function () {
        ...
        expect(shanten_1.fitsInSet(parse_1.parseOne("1s"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("4p"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("2m"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("3m"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("1m"), run)).toBeTrue();
        expect(shanten_1.fitsInSet(parse_1.parseOne("4m"), run)).toBeTrue();
    });
    it("should correctly identify what fits into a kanchan", function () {
        ...
        expect(shanten_1.fitsInSet(parse_1.parseOne("1z"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("r5m"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("1m"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("3s"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("2m"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("4m"), run)).toBeFalse();
        expect(shanten_1.fitsInSet(parse_1.parseOne("3m"), run)).toBeTrue();
    });
});
